...
# create monitor instance for KIND eyetracker room monitor
eyetracker_mon = monitors.Monitor(
    name='eyetracker_monitor',
    width=37.68,
    distance=60,
    notes='Eyetracker (Judith) room monitor at KIND.')

# set the pixel width/height of the eyetracker monitor
eyetracker_mon.setSizePix([1280, 1024])
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/workingman/Documents/ASD_and_Synesthesia/Python/psychopy/PsychoPy projects/eyetracker_room_experiments/click_baseline/click_baseline.py',
...
win = visual.Window(
    ...
    monitor=eyetracker_mon, color=[0,0,0], colorSpace='rgb',
...
text_instructions = visual.TextStim(win=win, name='text_instructions',
    text='Din uppgift i det här testet är att så snabbt du kan klicka med musen på samtliga siffror som kommer upp på skärmen i nummordning. Klicka alltså på alla siffrorna, i ordningen 1, 2, 3, 4… 9.\n\nAnvänd vänster musknapp.\n\nTestet tar ca 3 minuter att genomföra.',
    font='Arial',
...
text_end = visual.TextStim(win=win, name='text_end',
    text='Bra jobbat! \n\nMata in ditt deltagar-ID för kalibreringen som kommer härnäst.',
    font='Arial',
    units='deg', pos=(0, 0), height=TXT_SIZE_M, wrapWidth=26, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=0.0);
